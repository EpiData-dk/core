...
uses
  ...
  epiv_statusbar_item_progressbar, epiv_statusbar_item_saveicon, wizard_form, 
  wizard_datadir_frame, wizard_welcome_page, wizard_summary_frame, 
  wizard_progress_frame, wizard_confirm_frame, LazarusPackageIntf;
