...
Function  mibIsDate(VAR s:String; Style:TFieldtypes):Boolean;
Function  mibDateToStr(d:TDateTime; Style:TFieldtypes):String;
Function  mibStrToDate(s:String; Style:TFieldtypes):TDateTime;
Function  FormatNumberToIndex(s:String):string;
...
Function  IsCompliant(s:String; Style:TFieldtypes):Boolean;
