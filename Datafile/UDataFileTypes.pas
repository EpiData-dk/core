...
type
  ...
  TRequestPasswordEvent = procedure(Sender: TObject; RequestType: TRequestPasswordType; var Password: UTF8String) of object;

  TTranslateEvent       = function(LangCode: Integer; const Text: widestring): widestring of object;

  TProgressResult       = (prNormal, prCancel);
  TProgressEvent        = function(Sender: TObject; Percent: Cardinal; Msg: UTF8String): TProgressResult of object;
